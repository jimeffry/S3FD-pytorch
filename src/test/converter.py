...
def pbtxt_to_graphdef(filename):
    with open(filename, 'r') as f:
        ...
        tf.train.write_graph(graph_def, './', '../models/sfd_tf_b3.pb', as_text=False)
...
def graphdef_to_pbtxt(filename):
    with gfile.FastGFile(filename, 'rb') as f:
        ...
        tf.import_graph_def(graph_def, name='')
        tf.train.write_graph(graph_def, './', '../models/sfd_tf3.pbtxt', as_text=True)
    return


# here you can write the name of the file to be converted
pbtxt_to_graphdef('../models/sfd_tf3.pbtxt')
# here you can write the name of the file to be converted
# graphdef_to_pbtxt('../models/s3fd2.pb')
