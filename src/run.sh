...
python demo.py --modelpath /data/models/head/sfd_crowedhuman_75000.pth --img_dir /data/detect/Scut_Head/SCUT_HEAD_Part_B/JPEGImages --file_in /data/detect/Scut_Head/SCUT_HEAD_Part_B/ImageSets/Main/test.txt
#python train.py --dataset head --cuda false --save_folder /data/models/head/
